                ...
                >
                  <div className="relative overflow-hidden bg-white dark:bg-[#f5f0eb] rounded-2xl shadow-lg hover:shadow-2xl transition-all border border-gray-100 dark:border-[#ddd7d0] p-6">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-xs text-gray-500 dark:text-[#6a6a6a] uppercase tracking-wider font-medium">Companies</p>
                      <p className="text-xs text-gray-400 dark:text-[#8a8a8a] mt-1">Worked With</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="relative overflow-hidden bg-white dark:bg-[#f5f0eb] rounded-2xl shadow-lg hover:shadow-2xl transition-all border border-gray-100 dark:border-[#ddd7d0] p-6">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-xs text-gray-500 dark:text-[#6a6a6a] uppercase tracking-wider font-medium">Years</p>
                      <p className="text-xs text-gray-400 dark:text-[#8a8a8a] mt-1">Experience</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="relative overflow-hidden bg-white dark:bg-[#f5f0eb] rounded-2xl shadow-lg hover:shadow-2xl transition-all border border-gray-100 dark:border-[#ddd7d0] p-6">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-xs text-gray-500 dark:text-[#6a6a6a] uppercase tracking-wider font-medium">Technologies</p>
                      <p className="text-xs text-gray-400 dark:text-[#8a8a8a] mt-1">Mastered</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
